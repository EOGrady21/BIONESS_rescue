...
The following quality control comments were developed as a standard to represent
quality control results in plankton data, since there is no Flag column in the 
BioChem plankton schema.

(1) DATA QUALITY: QC HAS BEEN PERFORMED; ELEMENT APPEARS CORRECT.

(2) DATA QUALITY: QC HAS BEEN PERFORMED; ELEMENT APPEARS INCONSISTENT WITH OTHER ELEMENTS.

(3) DATA QUALITY: QC HAS BEEN PERFORMED; ELEMENT APPEARS DOUBTFUL.

(4) DATA QUALITY: QC HAS BEEN PERFORMED; ELEMENT APPEARS ERRONEOUS.
